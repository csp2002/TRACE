...
def eval(image_paths, mask_paths, medsam_model, save_dir):
    total_iou = 0.0
    total_dice = 0.0
...
if __name__ == "__main__":
    ...
    medsam_model.eval()
    num_params = sum(p.numel() for p in medsam_model.parameters() )
    ...
    eval(image_paths, mask_paths, medsam_model, save_dir)
